/*
  ...
  1. New Indexes
    - Combined index on user_id and category
    - Combined index on price and created_at
    - Index on condition for filtering
    
  2. Materialized View
    - Creates book_summaries view for frequently accessed data
    - Includes basic book info and owner details
