/*
  # Fix book summaries materialized view permissions

  1. Changes
    - Create indexes with proper ownership
    - Create materialized view with correct permissions
    - Set up refresh function with security definer
...
-- Create materialized view owned by postgres
...
-- Function to refresh materialized view with elevated privileges
...
GRANT EXECUTE ON FUNCTION refresh_book_summaries() TO authenticated;