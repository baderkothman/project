/*
  ...
  1. Changes
    - Add created_at column to shared_books table with default now()
    - Create index for better sorting performance
    - Create function to merge and sort messages and shared books
    - Add proper timestamp handling and fallbacks
